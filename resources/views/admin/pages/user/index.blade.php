        ...
        <tr>
            ...
            <td class="">
                <div class="form-check form-switch">
                    <input class="form-check-input toggle-class" type="checkbox" role="switch" data-id="{{ $user->id }}" id="user{{ $user->id }}" {{ $user->is_active ? 'checked':'' }}>
                  </div>
            </td>
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  <form action="{{ route('users.destroy', $user->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="dropdown-item show_confirm" href=""><i class="bx bx-trash me-1"></i>Delete</button>
                  </form>
                </div>
              </div>
            </td>
